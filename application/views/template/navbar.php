        ...
        <div class="row">
          <div class="span4">
            <div class="logo"  style="margin-top: -52px">
              <a href="index.html"><img src="<?php echo base_url()?>template/img/Logo-Dinkes.png" alt="" class="logo" width="70" width="100" /></a>
              <h5 style="text-shadow:2px 2px 4px #777; color:#009432">&nbsp;&nbsp;Jaringan Dokumentasi & Informasi Hukum</h5>
              <h1 class="span6" style="font-size: 17pt; font-weight: 'bold'; text-shadow:2px 2px 4px #777"><span style="color:#EE5A24; font-weight: bold"><b style="font-size: 20pt; color:#009432">J</b>DIH&nbsp;</span><span style="color:#2c3e50">Dinkes Prov DKI Jakarta</span></h1>
            </div>
          </div>
