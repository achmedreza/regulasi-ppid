  ...
  <div id="wrapper">
    ...
    <div class="hidden-top">
      <div class="hidden-top-inner container">
        <div class="row">
          <div class="span12">
            <ul>
              <li><strong>Pelayanan Dan Kepastian adalah Hak Semua Warga DKI Jakarta</strong></li>
              <li>Main office: Gedung Dinas Kesehatan Provinsi DKI Jakarta</li>
    ...
    <script type="text/javascript">
     ...
     <div class="alert" style="margin-bottom: -30px">
         <span class="primary"><marquee style="text-shadow:2px 2px 4px #777; letter-spacing: 0.1em;"><h5>Selamat Datang Di Website Regulasi Dinkes Provinsi DKI Jakarta, Berikut Produk Hukum Terbaru:<span style="color:#d35400">Keputusan Gubernur Nomor 243 Tahun 2018</span></h5></marquee></span>
     </div>
