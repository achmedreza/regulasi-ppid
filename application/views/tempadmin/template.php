...
<body>
	...
	<div id="wrapper">
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2022 <a href="https://www.themeineed.com" target="_blank">Dinas Kesehatan Provinsi DKI Jakarta developed by Seksi Data Informasi dan Kehumasan</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
